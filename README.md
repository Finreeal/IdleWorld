...
IDLEWORLD_APP_BUNDLE_ID=com.example.idleworld \
IDLEWORLD_WIDGET_BUNDLE_ID=com.example.idleworld.widget \
IDLEWORLD_MONITOR_BUNDLE_ID=com.example.idleworld.monitor \
IDLEWORLD_APP_GROUP=group.com.example.idleworld \
ruby scripts/generate_project.rb
```

3. Open `IdleWorld.xcodeproj` in Xcode and set up signing plus the shared App Group:

- `group.com.example.idleworld`
